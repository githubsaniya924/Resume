...
<?php
    ...
    $stmt = $conn->prepare("INSERT INTO participants(fname,lname,email_id,mobile_no,time_slot,occupation) VALUES(?,?,?,?,?,?)");

    $stmt->bind_param("sssdss",$fname,$lname,$email_id,$mobile_no,$time_slot,$occupation);
